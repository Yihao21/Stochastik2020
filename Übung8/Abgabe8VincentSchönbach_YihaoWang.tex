...
\begin{enumerate}[a)]
 ...
 \item $\hat \Omega = \lvert\{(\omega_1,\ldots,\omega_n) \mid \omega_1 = \ldots = \omega_{n-1} = 1, \omega_n = 0, n \in \mathbb{N}_0\} \rvert$ 1: stattgefunden 0: ausgefallen.\\
 $\hat \Omega = \mathbb{N}_0$,  $\hat A = 2^{\hat \Omega}$\\
 $\hat P(i) = (1-\hat p) \cdot \hat p^i$, $\forall i \in \mathbb{N}_0$
 \item $\hat p$: das Tutorium findet statt.\\
 $\hat P(5) + \hat P(6) = (1-\hat p) \cdot (\hat p^5 + \hat p^6) $
\end{enumerate}
